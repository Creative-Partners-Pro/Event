...
function renderHeader() {
    ...
    header.innerHTML = `
        ...
        <div class="absolute bottom-20 left-6 right-6">
            <!-- Таймер -->
            <div class="flex justify-center gap-2 mt-4 w-[45%] mx-auto" id="countdown-timer">
            ...
            <h1 class="text-4xl font-bold leading-tight tracking-tight text-white drop-shadow-lg mt-4">${configData.event.title}</h1>
        </div>
    `;
}
